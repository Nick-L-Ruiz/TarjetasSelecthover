...
titulo1 = "Programador";
titulo2 = "Desarrollador Movil";
titulo3 = "Desarrollador Web";
...
function box_selected1 () {
    ...
    document.getElementById("titular").innerHTML = titulo1;
...
function box_selected2 () {
    ...
    document.getElementById("titular").innerHTML = titulo2;
    console.log(value_box);
}
...
function box_selected3 () {
    ...
    document.getElementById("titular").innerHTML = titulo3;
    
    console.log(value_box);
}

if (value_box == 0) {
  document.getElementById("titular").innerHTML = "Elige uno";
}